...
public class ApplicationManager1 {
	...
	public ApplicationManager1(boolean openBrowser, String testName, String pkg) throws MalformedURLException {
		...
		if (openBrowser) {
			...
			driver = webDriverFactory.getInstance(paramsUtils, downloadsFolder);
			if (!paramsUtils.getPropValue(ParamsUtils.BROWSER_NAME).equals("mobile")) {
